...
constexpr ptrdiff_t dwClientState = 0x59F194;
...
constexpr ptrdiff_t dwEntityList = 0x4DFFF04;
constexpr ptrdiff_t dwForceAttack = 0x322DD0C;
constexpr ptrdiff_t dwForceAttack2 = 0x322DD18;
constexpr ptrdiff_t dwForceBackward = 0x322DD48;
constexpr ptrdiff_t dwForceForward = 0x322DD3C;
constexpr ptrdiff_t dwForceJump = 0x52BBC8C;
constexpr ptrdiff_t dwForceLeft = 0x322DD54;
constexpr ptrdiff_t dwForceRight = 0x322DD60;
constexpr ptrdiff_t dwGameDir = 0x63AD80;
constexpr ptrdiff_t dwGameRulesProxy = 0x532F4BC;
constexpr ptrdiff_t dwGetAllClasses = 0xE0BFDC;
constexpr ptrdiff_t dwGlobalVars = 0x59EE58;
constexpr ptrdiff_t dwGlowObjectManager = 0x535A9D8;
constexpr ptrdiff_t dwInput = 0x525D4D8;
constexpr ptrdiff_t dwInterfaceLinkList = 0x99BC84;
constexpr ptrdiff_t dwLocalPlayer = 0xDEA964;
constexpr ptrdiff_t dwMouseEnable = 0x5239138;
constexpr ptrdiff_t dwMouseEnablePtr = 0x5239108;
constexpr ptrdiff_t dwPlayerResource = 0x322C0B0;
constexpr ptrdiff_t dwRadarBase = 0x52369DC;
constexpr ptrdiff_t dwSensitivity = 0xDEEB80;
constexpr ptrdiff_t dwSensitivityPtr = 0xDEEB80;
constexpr ptrdiff_t dwSetClanTag = 0x8DA80;
constexpr ptrdiff_t dwViewMatrix = 0x4DF0D34;
constexpr ptrdiff_t dwWeaponTable = 0x525E5B4;
constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
constexpr ptrdiff_t dwYawPtr = 0xDEE910;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDF4380;
constexpr ptrdiff_t dwbSendPackets = 0xDD102;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA62C0;
constexpr ptrdiff_t m_pStudioHdr = 0x2950;
constexpr ptrdiff_t m_yawClassPtr = 0xDEE910;
constexpr ptrdiff_t m_pitchClassPtr = 0x5239030;
...
constexpr ptrdiff_t model_ambient_min = 0x5A118C;
constexpr ptrdiff_t set_abs_angles = 0x1E72D0;
constexpr ptrdiff_t set_abs_origin = 0x1E7110;
constexpr ptrdiff_t is_c4_owner = 0x3E69E0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3D91CA;
constexpr ptrdiff_t anim_overlays = 0x2990;
constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
constexpr ptrdiff_t find_hud_element = 0x300EFBD0;
